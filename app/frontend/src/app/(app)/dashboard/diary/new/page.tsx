...
import { ArrowLeft, Camera, Mic, MicOff, X } from 'lucide-react'
...
export default function NewDiaryPage() {
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		// In a real app, you would upload images and save the diary entry
		console.log('[v0] New diary entry:', {
			title,
			content,
				...
				<div className="max-w-4xl mx-auto p-4 lg:p-8">
					...
					<form onSubmit={handleSubmit} className="space-y-6">
						...
						<div className="flex gap-3 pt-4">
							<Link href="/diaries" className="flex-1">
								<Button
									type="button"
									variant="outline"
