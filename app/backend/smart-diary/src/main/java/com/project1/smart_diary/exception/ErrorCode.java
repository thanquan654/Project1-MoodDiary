...
public enum ErrorCode {
    ...
    EMAIL_EXISTED(1008, "Địa chỉ email này đã được sử dụng.", HttpStatus.CONFLICT),
    EMAIL_NOT_EXISTED(1009, "Email hoặc mật khẩu không chính xác.", HttpStatus.UNAUTHORIZED),
    PASSWORD_NOT_EXISTED(2000, "Email hoặc mật khẩu không chính xác.", HttpStatus.UNAUTHORIZED),
    ...
    INVALID_KEYWORD(3005, "Keyword không hợp lệ. Vui lòng nhập 1 từ khóa tùy ý, không gửi về rỗng", HttpStatus.BAD_REQUEST),
